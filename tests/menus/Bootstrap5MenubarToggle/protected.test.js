...
describe("Bootstrap5MenubarToggle protected methods", () => {
  ...
  describe("_expand", () => {
    // Test that Bootstrap5MenubarToggle does not implement the MenubarToggle _expand.
    it("should not implement the MenubarToggle _expand", () => {
      expect(Bootstrap5MenubarToggle.prototype._expand).not.toBe(
  ...
  describe("_collapse", () => {
    // Test that Bootstrap5MenubarToggle does not implement the MenubarToggle _collapse.
    it("should not implement the MenubarToggle _collapse", () => {
      expect(Bootstrap5MenubarToggle.prototype._collapse).not.toBe(
