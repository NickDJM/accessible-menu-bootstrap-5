...
describe("Bootstrap5DisclosureMenuToggle protected methods", () => {
  ...
  describe("_expand", () => {
    // Test that Bootstrap5DisclosureMenuToggle does not implement the DisclosureMenuToggle _expand.
    it("should not implement the DisclosureMenuToggle _expand", () => {
      expect(Bootstrap5DisclosureMenuToggle.prototype._expand).not.toBe(
  ...
  describe("_collapse", () => {
    // Test that Bootstrap5DisclosureMenuToggle does not implement the DisclosureMenuToggle _collapse.
    it("should not implement the DisclosureMenuToggle _collapse", () => {
      expect(Bootstrap5DisclosureMenuToggle.prototype._collapse).not.toBe(
