/**
 * Test the Bootstrap5TopLinkDisclosureMenu class to make sure it functions correctly.
 */
...
openClose(Bootstrap5TopLinkDisclosureMenu);
clickTests(Bootstrap5TopLinkDisclosureMenu);
hoverTests(Bootstrap5TopLinkDisclosureMenu);
baseKeypressTests(Bootstrap5TopLinkDisclosureMenu);

describe('Bootstrap5TopLinkDisclosureMenu specific with hoverType "on"', () => {
...
describe(`Bootstrap5TopLinkDisclosureMenu specific with hoverType "dynamic"`, () => {
...
describe("Bootstrap5TopLinkDisclosureMenu keypress tests", () => {
...
describe("Bootstrap5TopLinkDisclosureMenu optional keypress tests", () => {
...
describe("Bootstrap5TopLinkDisclosureMenu submenu keypress tests", () => {
  describe("'Escape' key", () => {
    const key = "Escape";
