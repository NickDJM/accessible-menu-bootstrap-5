/**
 * Initialization tests for the Bootstrap5Menubar class.
 *
 * These tests are mostly covered by other tests, but are here just to ensure
 * that the Bootstrap5Menubar class can be initialized.
 */
...
// Test the Bootstrap5Menubar initialization.
describe("Bootstrap5Menubar", () => {
  // Test that the Bootstrap5Menubar will initialize if the menuElement passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if no menuElement is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if the menuElement is invalid.
...
// Test the Bootstrap5Menubar initialization for a controlled menu.
describe("Bootstrap5Menubar (controlled)", () => {
  // Test that the Bootstrap5Menubar will initialize if the menuElement passed.
  it("should initialize", () => {
    // Create the test menu.
    document.body.innerHTML = singleLevel;
  ...
  // Test that the Bootstrap5Menubar will throw an error if no containerElement is passed when a controllerElement is.
  ...
  // Test that the Bootstrap5Menubar will throw an error if the containerElement is invalid when a controllerElement is.
  ...
  // Test that the Bootstrap5Menubar will throw an error if no controllerElement is passed when a containerElement is.
  ...
  // Test that the Bootstrap5Menubar will throw an error if the controllerElement is invalid when a containerElement is.
...
// Test the Bootstrap5Menubar initialization with custom arguments.
describe("Bootstrap5Menubar (custom arguments)", () => {
  // Test that the Bootstrap5Menubar will initialize if a valid menuItemSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid menuItemSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid menuLinkSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid menuLinkSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid submenuItemSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid submenuItemSelector is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid submenuSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid submenuSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if valid class lists are passed.
  it.each(classLists)(
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid class list is passed.
  it.each(classLists)(
  ...
  // Thest that the Bootstrap5Menubar will initialize if isTopLevel is true.
  ...
  // Test that the Bootstrap5Menubar will throw an error if isTopLevel not a boolean.
  ...
  // Test that the Bootstrap5Menubar will throw an error is isTopLevel is false and no parentMenu is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if isTopLevel is false and a parentMenu is passed.
  it("should initialize if isTopLevel is false and a parentMenu is passed", () => {
    // Create a new Bootstrap5Menubar instance for testing.
    const parentMenu = new Bootstrap5Menubar({
      menuElement: document.querySelector("ul"),
      isTopLevel: true,
    });
  ...
  // Test that the Bootstrap5Menubar will throw an error if isTopLevel is false and an invalid parentMenu is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid parentMenu is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid parentMenu is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid hoverType is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid hoverType is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid hoverDelay is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid hoverDelay is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid enterDelay is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid enterDelay is passed.
  ...
  // Test that the Bootstrap5Menubar will initialize if a valid leaveDelay is passed.
  ...
  // Test that the Bootstrap5Menubar will throw an error if an invalid leaveDelay is passed.
...
describe("Bootstrap5Menubar (controlled initialization)", () => {
  ...
  it("should initialize if initialize is set to true", () => {
    ...
    vi.spyOn(Bootstrap5Menubar.prototype, "initialize");
    ...
    expect(Bootstrap5Menubar.prototype.initialize).toHaveBeenCalled();
  });
  ...
  it("should not initialize if initialize is set to false", () => {
    ...
    expect(Bootstrap5Menubar.prototype.initialize).not.toHaveBeenCalled();
  });
});
