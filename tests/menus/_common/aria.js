...
export function aria(MenuClass) {
  ...
  describe(`${menuType}`, () => {
    ...
    const expectedItemRole =
      menuType === "Bootstrap5Menubar" ? "menuitem" : "treeitem";
    const submenus = [
      { index: 0, id: 2 },
      { index: 1, id: 3 },
      { index: 2, id: 5 },
    ...
    if (menuType === "Bootstrap5Menubar" || menuType === "Bootstrap5Treeview") {
