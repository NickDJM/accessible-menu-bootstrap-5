/**
 * Test the Bootstrap5DisclosureMenu class to make sure it functions correctly.
 *
...
openClose(Bootstrap5DisclosureMenu);
clickTests(Bootstrap5DisclosureMenu);
hoverTests(Bootstrap5DisclosureMenu);
baseKeypressTests(Bootstrap5DisclosureMenu);

describe("Bootstrap5DisclosureMenu keypress tests", () => {
...
describe("Bootstrap5DisclosureMenu optional keypress tests", () => {
...
describe("Bootstrap5DisclosureMenu submenu keypress tests", () => {
  describe("'Escape' key", () => {
    const key = "Escape";
