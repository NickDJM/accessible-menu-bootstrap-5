/**
 * Initialization tests for the Bootstrap5DisclosureMenu class.
 *
...
// Test the Bootstrap5DisclosureMenu initialization.
describe("Bootstrap5DisclosureMenu", () => {
  // Test that the Bootstrap5DisclosureMenu will initialize if the menuElement passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if no menuElement is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if the menuElement is invalid.
...
// Test the Bootstrap5DisclosureMenu initialization for a controlled menu.
describe("Bootstrap5DisclosureMenu (controlled)", () => {
  // Test that the Bootstrap5DisclosureMenu will initialize if the menuElement passed.
  it("should initialize", () => {
    // Create the test menu.
    document.body.innerHTML = singleLevel;
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if no containerElement is passed when a controllerElement is.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if the containerElement is invalid when a controllerElement is.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if no controllerElement is passed when a containerElement is.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if the controllerElement is invalid when a containerElement is.
...
// Test the Bootstrap5DisclosureMenu initialization with custom arguments.
describe("Bootstrap5DisclosureMenu (custom arguments)", () => {
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid menuItemSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid menuItemSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid menuLinkSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid menuLinkSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid submenuItemSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid submenuItemSelector is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid submenuSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid submenuSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if valid class lists are passed.
  it.each(classLists)(
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid class list is passed.
  it.each(classLists)(
  ...
  // Thest that the Bootstrap5DisclosureMenu will initialize if isTopLevel is true.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if isTopLevel not a boolean.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error is isTopLevel is false and no parentMenu is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if isTopLevel is false and a parentMenu is passed.
  it("should initialize if isTopLevel is false and a parentMenu is passed", () => {
    // Create a new Bootstrap5DisclosureMenu instance for testing.
    const parentMenu = new Bootstrap5DisclosureMenu({
      menuElement: document.querySelector("ul"),
      isTopLevel: true,
    });
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if isTopLevel is false and an invalid parentMenu is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid parentMenu is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid parentMenu is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid hoverType is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid hoverType is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid hoverDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid hoverDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid enterDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid enterDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid leaveDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid leaveDelay is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will initialize if a valid optionalKeySupport is passed.
  ...
  // Test that the Bootstrap5DisclosureMenu will throw an error if an invalid optionalKeySupport is passed.
...
describe("Bootstrap5DisclosureMenu (controlled initialization)", () => {
  ...
  it("should initialize if initialize is set to true", () => {
    ...
    vi.spyOn(Bootstrap5DisclosureMenu.prototype, "initialize");
    ...
    expect(Bootstrap5DisclosureMenu.prototype.initialize).toHaveBeenCalled();
  });
  ...
  it("should not initialize if initialize is set to false", () => {
    ...
    expect(
      Bootstrap5DisclosureMenu.prototype.initialize
