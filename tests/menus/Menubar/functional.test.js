...
openClose(Bootstrap5Menubar);
clickTests(Bootstrap5Menubar);
hoverTests(Bootstrap5Menubar);
baseKeypressTests(Bootstrap5Menubar);

describe("Bootstrap5Menubar keypress tests", () => {
...
describe("Bootstrap5Menubar submenu keypress tests", () => {
  describe.each(["Spacebar", "Enter"])("'%s' key", (key) => {
    test("Opens submenu and moves focus to first item in the submenu.", () => {
      // Set up the DOM.
      document.body.innerHTML = fullMenu;
