...
describe("Bootstrap5TreeviewToggle protected methods", () => {
  ...
  describe("_expand", () => {
    // Test that Bootstrap5TreeviewToggle does not implement the TreeviewToggle _expand.
    it("should not implement the TreeviewToggle _expand", () => {
      expect(Bootstrap5TreeviewToggle.prototype._expand).not.toBe(
  ...
  describe("_collapse", () => {
    // Test that Bootstrap5TreeviewToggle does not implement the TreeviewToggle _collapse.
    it("should not implement the TreeviewToggle _collapse", () => {
      expect(Bootstrap5TreeviewToggle.prototype._collapse).not.toBe(
