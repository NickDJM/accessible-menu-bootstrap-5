...
var Bootstrap5MenubarItem = function (_MenubarItem) {
  _inherits$2(Bootstrap5MenubarItem, _MenubarItem);
  var _super = _createSuper$2(Bootstrap5MenubarItem);
  function Bootstrap5MenubarItem(_ref) {
    ...
    var menuItemElement = _ref.menuItemElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$2(this, Bootstrap5MenubarItem);
    _this = _super.call(this, {
      menuItemElement: menuItemElement,
      menuLinkElement: menuLinkElement,
      parentMenu: parentMenu,
...
var Bootstrap5MenubarToggle = function (_MenubarToggle) {
  _inherits$1(Bootstrap5MenubarToggle, _MenubarToggle);
  var _super = _createSuper$1(Bootstrap5MenubarToggle);
  function Bootstrap5MenubarToggle(_ref) {
    ...
    var menuToggleElement = _ref.menuToggleElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$1(this, Bootstrap5MenubarToggle);
    _this = _super.call(this, {
      menuToggleElement: menuToggleElement,
      parentElement: parentElement,
      controlledMenu: controlledMenu,
  ...
  _createClass(Bootstrap5MenubarToggle, [{
    key: "initialize",
    value: function initialize() {
      _get(_getPrototypeOf$1(Bootstrap5MenubarToggle.prototype), "initialize", this).call(this);
...
var Bootstrap5Menubar = function (_Menubar) {
  _inherits(Bootstrap5Menubar, _Menubar);
  var _super = _createSuper(Bootstrap5Menubar);
  function Bootstrap5Menubar(_ref) {
    ...
    var menuElement = _ref.menuElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck(this, Bootstrap5Menubar);
    _this = _super.call(this, {
      menuElement: menuElement,
      menuItemSelector: menuItemSelector,
      menuLinkSelector: menuLinkSelector,
    ...
    _defineProperty(_assertThisInitialized(_this), "_MenuType", Bootstrap5Menubar);
    _defineProperty(_assertThisInitialized(_this), "_MenuItemType", Bootstrap5MenubarItem);
    _defineProperty(_assertThisInitialized(_this), "_MenuToggleType", Bootstrap5MenubarToggle);
    if (initialize) {
      _this.initialize();
    }
    return _this;
...
export { Bootstrap5Menubar as default };
//# sourceMappingURL=menubar-bs5.esm.js.map
