...
var Bootstrap5DisclosureMenuItem = function (_DisclosureMenuItem) {
  _inherits$2(Bootstrap5DisclosureMenuItem, _DisclosureMenuItem);
  var _super = _createSuper$2(Bootstrap5DisclosureMenuItem);
  function Bootstrap5DisclosureMenuItem(_ref) {
    ...
    var menuItemElement = _ref.menuItemElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$2(this, Bootstrap5DisclosureMenuItem);
    _this = _super.call(this, {
      menuItemElement: menuItemElement,
      menuLinkElement: menuLinkElement,
      parentMenu: parentMenu,
...
var Bootstrap5DisclosureMenuToggle = function (_DisclosureMenuToggle) {
  _inherits$1(Bootstrap5DisclosureMenuToggle, _DisclosureMenuToggle);
  var _super = _createSuper$1(Bootstrap5DisclosureMenuToggle);
  function Bootstrap5DisclosureMenuToggle(_ref) {
    ...
    var menuToggleElement = _ref.menuToggleElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$1(this, Bootstrap5DisclosureMenuToggle);
    _this = _super.call(this, {
      menuToggleElement: menuToggleElement,
      parentElement: parentElement,
      controlledMenu: controlledMenu,
  ...
  _createClass(Bootstrap5DisclosureMenuToggle, [{
    key: "initialize",
    value: function initialize() {
      _get(_getPrototypeOf$1(Bootstrap5DisclosureMenuToggle.prototype), "initialize", this).call(this);
...
var Bootstrap5DisclosureMenu = function (_DisclosureMenu) {
  _inherits(Bootstrap5DisclosureMenu, _DisclosureMenu);
  var _super = _createSuper(Bootstrap5DisclosureMenu);
  function Bootstrap5DisclosureMenu(_ref) {
    ...
    var menuElement = _ref.menuElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck(this, Bootstrap5DisclosureMenu);
    _this = _super.call(this, {
      menuElement: menuElement,
      menuItemSelector: menuItemSelector,
      menuLinkSelector: menuLinkSelector,
    ...
    _defineProperty(_assertThisInitialized(_this), "_MenuType", Bootstrap5DisclosureMenu);
    _defineProperty(_assertThisInitialized(_this), "_MenuItemType", Bootstrap5DisclosureMenuItem);
    _defineProperty(_assertThisInitialized(_this), "_MenuToggleType", Bootstrap5DisclosureMenuToggle);
    if (initialize) {
      _this.initialize();
    }
    return _this;
...
export { Bootstrap5DisclosureMenu as default };
//# sourceMappingURL=disclosure-menu-bs5.esm.js.map
