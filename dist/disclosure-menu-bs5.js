var Bootstrap5DisclosureMenu = (function () {
  ...
  class Bootstrap5DisclosureMenu extends DisclosureMenu {
    constructor(_ref) {
      ...
      _defineProperty(this, "_MenuType", Bootstrap5DisclosureMenu);
      _defineProperty(this, "_MenuItemType", Bootstrap5DisclosureMenuItem);
      _defineProperty(this, "_MenuToggleType", Bootstrap5DisclosureMenuToggle);
      if (initialize) {
        this.initialize();
      }
    }
